...
<body>
    ...
    <div class="projects-body">
        <div class="categories">
            <!-- Section for Type of Work filter -->
            <div class="type-of-work">
                <p>Type of Work</p>
                <?php
                // SQL query to select distinct values of type_of_work
            ...
            <!-- Section for Industry filter -->
            <div class="industry">
                <p>Industry</p>
                <?php
                // SQL query to select distinct values of industry
