                ...
                <form action="../admin/Update.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-row">
                        <div class="mb-3">
                            ...
                            <input style="width:400px;" type="text" class="form-control" id="client" name="client" value="<?php echo $result['client']; ?>" required>
                        </div>
                        <div class="mb-3">
                            <label for="description_short" class="form-label">Short Description</label>
                            <input style="width:700px;" type="text" class="form-control" id="description_short" name="description_short" value="<?php echo $result['description_short']; ?>" required>
                        </div>
                    </div>
                    <div class="mb-3">
                        <label for="description_long" class="form-label">Long Description</label>
                        <textarea type="text" class="form-control" id="description_long" name="description_long" rows="5" required><?php echo htmlspecialchars($result['description_long']); ?></textarea>
                    </div>
                    <div class="form-row">
                        <div class="mb-3">
                            <label for="type_of_work" class="form-label">Type of Work</label>
                            <input style="width:400px;" type="text" class="form-control" id="type_of_work" name="type_of_work" value="<?php echo $result['type_of_work']; ?>" required>
                        </div>
                        <div class="mb-3">
                            <label for="industry" class="form-label">Industry</label>
                            <input style="width:400px;" type="text" class="form-control" id="industry" name="industry" value="<?php echo $result['industry']; ?>" required>
                        </div>
                        <div class="mb-3">
                            <label for="year" class="form-label">Year</label>
                            <input style="width:400px;" type="text" class="form-control" id="year" name="year" value="<?php echo $result['year']; ?>" required>
                        </div>
                    </div>
                    <div class="mb-3">
                        <label for="url" class="form-label">Website URL</label>
                        <input type="text" class="form-control" id="url" name="url" value="<?php echo $result['url']; ?>">
                    </div>
                    <div class="form-row">
                        <div class="mb-3">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="currentImage">
                                            ...
                                            <?php if ($thumbnail): ?>
                                                Current Thumbnail:
                                                <video src="<?php echo "../uploads/" . $thumbnail['image_url']; ?>" width="100px" alt=""></video>
                                                <img src="<?php echo "../uploads/" . $thumbnail['image_url']; ?>" width="100px" alt="">
                                                <button type="button" class="btn btn-danger btn-sm del-btn" onclick="deleteImage(this, '<?php echo $thumbnail['image_id']; ?>', '<?php echo $thumbnail['image_url']; ?>')">Delete</button>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="currentImage">
                                            ...
                                            <?php if ($hover): ?>
                                                Current Hover Image:
                                                <video src="<?php echo "../uploads/" . $hover['image_url']; ?>" width="100px" alt=""></video>
                                                <img src="<?php echo "../uploads/" . $hover['image_url']; ?>" width="100px" alt="">
                                                <button type="button" class="btn btn-danger btn-sm del-btn" onclick="deleteImage(this, '<?php echo $hover['image_id']; ?>', '<?php echo $hover['image_url']; ?>')">Delete</button>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="mb-5">
                        <label for="Project-image" class="form-label">Project Images</label>
                                    ...
                                    <div class="currentImages" style="display:flex;gap:30px">
                                        <?php foreach ($projectImages as $projectImage): ?>
                                            <div class="currentImage">
                                                ...
                                                <video src="<?php echo "../uploads/" . $projectImage['image_url']; ?>" width="100px" alt=""></video>
